...
class Curve:
    ...
    def X(self):
        ...
        if hasattr(temp,'_data'):
            temp = temp._data[:]
        return Numeric.array(temp,Numeric.float64)
    ...
    def Y(self):
        ...
        return Numeric.array(outArray,Numeric.float64)
...
def polint(xa,ya,x):
    ...
    c = Numeric.zeros(n,Numeric.float64)
    d = Numeric.zeros(n,Numeric.float64)
    c[:] = ya[:]
    d[:] = ya[:]
